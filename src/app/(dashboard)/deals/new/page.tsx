  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-slate-500 text-sm mt-0.5">Add a new deal to your pipeline</p>
      </div>
        ...
        <form action={createDeal} className="space-y-5">
          <div>
            ...
            <input
              ...
              type="text"
              required
              placeholder="e.g. 123 Main St - Office Complex"
          ...
          <div>
            ...
            <textarea
              ...
              name="description"
              rows={4}
              placeholder="Describe the deal, property details, requirements..."
